    ...
    <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogContent className="sm:max-w-[560px] max-h-[90vh] overflow-y-auto bg-[#eeeeee]">
        ...
        <div className="space-y-4 pt-2">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="text-[16px] text-gray-700 mb-1 block">
                First Name <span className="text-[#014ec3]">*</span>
              </label>
              <Input
              ...
              />
              {errors.firstName && (
                <p className="text-xs text-[#014ec3] mt-1">{errors.firstName}</p>
              )}
            </div>
            <div>
              <label className="text-[16px] text-gray-700 mb-1 block">
                Last Name <span className="text-[#014ec3]">*</span>
              </label>
              <Input
              ...
              />
              {errors.lastName && (
                <p className="text-xs text-[#014ec3] mt-1">{errors.lastName}</p>
              )}
            </div>
          </div>
          <div>
          ...
          <div>
            <label className="text-[16px] text-gray-700 mb-1 block">
              Address Line 1 <span className="text-[#014ec3]">*</span>
            </label>
            <Input
            ...
            />
            {errors.address1 && (
              <p className="text-xs text-[#014ec3] mt-1">{errors.address1}</p>
            )}
          </div>
          <div>
            <label className="text-[16px] text-gray-700 mb-1 flex justify-between">
          ...
          <div>
            <label className="text-[16px] text-gray-700 mb-1 block">
              City <span className="text-[#014ec3]">*</span>
            </label>
            <Input
              value={value.city}
              onChange={(e) => {
            ...
            />
            {errors.city && (
              <p className="text-xs text-[#014ec3] mt-1">{errors.city}</p>
            )}
          </div>
          {/* <div>
                        <label className="text-[16px] text-gray-700 mb-1 block">City <span className="text-[#014ec3]">*</span></label>
                        ...
                        {errors.city && <p className="text-xs text-[#014ec3] mt-1">{errors.city}</p>}
          ...
          <div>
            ...
            {errors.country && (
              <p className="text-xs text-[#014ec3] mt-1">{errors.country}</p>
            )}
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              {errors.state && (
                <p className="text-xs text-[#014ec3] mt-1">{errors.state}</p>
              )}
            </div>
            <div>
              <label className="text-[16px] text-gray-700 mb-1 block">
              ...
              />
              {errors.zip && (
                <p className="text-xs text-[#014ec3] mt-1">{errors.zip}</p>
              )}
            </div>
          </div>
        ...
        <div className="px-6 py-3 bg-gray-50 border-b flex justify-between items-center">
          ...
          <div className="flex gap-4">
            <button
              ...
              className="text-[16px] text-[#014ec3] hover:underline"
            >
              Clear all
            </button>
            <button
  ...
  return (
    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-4 text-[1rem]">
                          <button
                            ...
                            className="text-xs text-[#014ec3] hover:underline"
                          >
      ...
      {!lastDestComplete && destinations.length > 0 && (
        <p className="text-[13px] text-[#014ec3] flex items-center gap-1">
          <span>✕</span>
